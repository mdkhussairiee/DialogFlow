...
app.post("/dialogflow", express.json(), (req, res) => {
  ...
  async function defaultFallback(agent) {
      ...
      const dialog = [
        ...
        AI: Hello, I am Eddie! I am your virtual personal assistant from Asrix Prime. How are you doing today?`,
      ];
      ...
      const completionParams = {
        ...
        echo: false,
        stop: '\n',
        engine: 'text-davinci-005' // use GPT-3.5-turbo engine
      };
    
      try {
        const result = await instance.post('/completions', completionParams);
